      ...
      <div className="section-block grey-bg background-shape-3">
        <div className="container">
          <div className="row">
            <div className="col-12">
              ...
              <div className="text-content mt-15 text-justify">
                <p style={{ lineHeight: "2.5" }}>
                  AMC is a Premium multi-nucleic real estate development that is
                  slated to redefine the concept of urban living within Awka,
                  Anambra state. The developer (M-P Infrastructure Ltd)
                  envisions a new residential layout whose development will
                  boost economic activity while increasing the quality of
                  housing in the state capital territory. The commercial avenue,
                  cascaded to include developments such as worship centres,
                  recreational establishments, offices, malls, restaurants etc.
                  enables AMC facilitate the concept of Live, work & play as a
                  one stop destination. AMC will be underpinned by quality
                  municipal infrastructure, seamlessly integrated via the
                  adoption of technology, that will guarantee seamless provision
                  of requisite amenities needed to sustain a good quality
                  lifestyle. Owing to its adoption of technology in various
                  components of the development, AMC is poised to become the
                  first smart city in the South East upon completion.
                </p>
              </div>
            </div>
            {/* Statement */}
            <div className="col-md-6 col-12">
              ...
              <div className="text-content mt-15 text-justify">
                <p style={{ lineHeight: "2.5" }}>
                  ...
                  Africa's largest market in Onitsha. The state is ranked 1st in
                  commercial trade volume in Nigeria's South-East region and
                  known as one of the fastest growing economies in business hubs
                  in Nigeria.
                </p>
                <p>
                  AMC will be a haven strategically located in Awka City.
                  Conveniently located just steps from the new Government State
                  House. It is positioned about 40km from the beautiful River
                  Niger, making it easily accessible from Asaba International
                  Airport. It's also conveniently accessible via Old
                  Onitsha-Enugu road which is linked to the Onitsha-Enugu
                  Express way.
                </p>
                <p>
                  AMC has three major Airports within a 100km radius, Anambra
                  International Cargo Airport, Umueri, Akanu Ibiam International
                  Airport, Enugu and Asaba International Airport.
                </p>
            ...
            {/*  Map */}
            <div className="col-md-6 col-12">
              <div className="shadow-primary p-3" style={{ marginTop: "40px" }}>
                <iframe
      ...
      <div className="section-block grey-bg background-shape-3">
        <div className="container">
          <div className="section-heading text-center">
            ...
            <p>
              AMC is rich with a lot of Infrastructures which will give you all
              ...
              >
                {
                  <iframe
                    width="560"
                    height="500"
                    src="https://www.youtube.com/embed/pntUZFjoqpo"
            ...
            <div className="col-md-6 col-sm-12 col-12">
              <div className="pl-45-md">
                <div className="section-heading">
                  ...
                  <p>
                    The entire development sits on approximately 100 hectares of
                    Land.
                  </p>
                </div>
                <div>
